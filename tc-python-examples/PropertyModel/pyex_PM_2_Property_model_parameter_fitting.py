...
.. note::
    ...
    Property Model Development Framework' interface methods :func:`provide_model_parameters` and 
    :func:`set_model_parameter`.
"""
...
with TCPython() as session:
    ...
    # subdirectory
    print("Available property models : {}".format(session.get_property_models("PropertyModels")))
    calculator = (system
                  .with_property_model_calculation("Simple linear model", "PropertyModels")
